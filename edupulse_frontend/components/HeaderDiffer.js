    ...
    <>
      <header className="header-diff">
        ...
        <nav className="nav-bar-diff">
          ...
          <Link href="/books" className="nav-link-diff">Books</Link>
          <Link href="/qa" className="nav-link-diff">Courses</Link>
          <Link href="/survey" className="nav-link-diff">Career Survey</Link>
          <Link href="/scheduler" className="nav-link-diff">Scheduler</Link>
